 ...
 * @author user
 */
public class FLog extends javax.swing.JInternalFrame {
    ...
    private void lThongke() throws Exception {
        rs = con.excuteQuery("Select * from log");
        int i = 0;
        while (rs.next()) {
            i++;
        }
        jLabel12.setText("Hiện tại đang có " + i + " nhật ký");
        rs.close();
    }
    ...
    private void loadTable() throws Exception {
        ...
        int numberColunm = metadata.getColumnCount();
        String a[] = {"Cán Bộ", "Công Việc", "Ngày", "Giờ"};
...
//        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int j = JOptionPane.showConfirmDialog(this, "Bạn có thật sự muốn xóa không?", "Chú ý", JOptionPane.YES_NO_OPTION);
        if (j == 0) {
            try {
                int a = con.executeUpdate("DELETE FROM log");               
